...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-3 overflow-hidden rounded-xl border border-transparent px-3.5 py-3 text-left text-base ring-sidebar-ring outline-hidden transition-[width,height,padding,transform,box-shadow,background-color,border-color,color] duration-200 group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-9! group-data-[collapsible=icon]:p-2! hover:translate-x-0.5 hover:border-sidebar-border hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-sm focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:border-sidebar-border data-active:bg-sidebar-primary data-active:font-medium data-active:text-sidebar-primary-foreground data-active:shadow-sm [&_svg]:size-5 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        ...
        align="center"
        withArrow={false}
        sideOffset={tooltipSideOffset ?? 10}
        className={cn(
          "rounded-xl border border-[#fcd5ce] bg-[#fff8f6]/95 px-3 py-2 text-sm font-semibold text-[#5b463f] shadow-[0_10px_24px_rgba(63,45,40,0.18)] backdrop-blur-sm",
          tooltipClassName
        )}
