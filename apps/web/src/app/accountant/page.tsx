        ...
        <DashboardLayout>
            <div className="p-6 space-y-6">
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <BreadcrumbList className="text-sm text-[#8f6f64]">
                            <BreadcrumbItem>
                                <BreadcrumbLink asChild className="hover:text-[#5b463f]">
                                    <Link href="/accountant">Kế toán</Link>
                                </BreadcrumbLink>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                    ...
                    <button className="inline-flex items-center gap-2 rounded-lg border border-[#fcd5ce] bg-[#fff8f6] px-4 py-2 text-sm font-medium text-[#5b463f] hover:bg-[#f8edeb] w-fit">
