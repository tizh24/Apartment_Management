            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div className="rounded-2xl border border-[#fcd5ce] bg-white p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-[11px] font-bold text-[#8f6f64] uppercase tracking-wider">Tổng cộng CTV</span>
                    ...
                    <p className="text-[10px] text-[#caa79a] mt-0.5">Số lượng CTV liên kết</p>
                </div>
                ...
                <div className="rounded-2xl border border-blue-200 bg-white p-4 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="text-[10px] text-[#caa79a] mt-0.5">Cộng tác viên kích hoạt</p>
                </div>
                ...
                <div className="rounded-2xl border border-amber-200 bg-white p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-[11px] font-bold text-[#8f6f64] uppercase tracking-wider">Tổng hoa hồng</span>
                    ...
                    <p className="text-[10px] text-[#caa79a] mt-0.5">Doanh số hoa hồng tích lũy</p>
                </div>

                {/* Đã chi trả */}
                <div className="rounded-2xl border border-emerald-200 bg-white p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-[11px] font-bold text-[#8f6f64] uppercase tracking-wider">Đã quyết toán</span>
                    ...
                    <p className="text-[10px] text-[#caa79a] mt-0.5">Tiền mặt + Chuyển khoản bank</p>
                </div>
                ...
                <div className="rounded-2xl border border-red-200 bg-white p-4 shadow-sm hover:shadow-md transition-shadow col-span-2 lg:col-span-1">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-[11px] font-bold text-[#8f6f64] uppercase tracking-wider">Còn nợ (Unpaid)</span>
                    ...
                    <p className="text-[10px] text-[#b89184] mt-0.5">Hoa hồng chờ thanh toán</p>
                </div>
